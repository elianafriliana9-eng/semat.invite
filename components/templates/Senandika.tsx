...
export default function SenandikaTemplate({ data }: SenandikaTemplateProps) {
    ...
    return (
        <div className="font-sans antialiased min-h-screen text-[#181310] dark:text-[#f1ecea] transition-colors duration-500 overflow-x-hidden"
            style={{
        ...
        >
            ...
            <style jsx global>{`
                @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700&family=Cormorant+Garamond:ital,wght@1,300;1,400;1,500;1,600&display=swap');
            ...
            <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden" id="hero">
                ...
                <div className="container mx-auto px-4 flex flex-col items-center text-center z-10">
                    ...
                    <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-40">
                        ...
                        <div className="w-[1px] h-12 bg-gradient-to-b from-transparent to-transparent"
